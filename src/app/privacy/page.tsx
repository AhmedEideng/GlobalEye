    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="prose max-w-none">
        <p className="text-lg mb-6">
          At GlobalEye News, we take your privacy seriously. This Privacy Policy explains how we collect, 
        ...
        <p className="mb-6">
          ...
          subscribe to our newsletter, or contact us. This may include your name, email address, and 
        ...
        <p className="mb-6">
          ...
          updates about our services or to respond to your inquiries.
        </p>
        ...
        <p className="mb-6">
          ...
          trusted third-party service providers who assist us in operating our website and providing our services.
        </p>
        ...
        <p className="mb-6">
          ...
          These technologies help us understand how you use our site and allow us to improve our services.
        </p>
        
        <h2 className="text-2xl font-semibold mb-4">Your Rights</h2>
        <p className="mb-6">
          You have the right to access, update, or delete your personal information. You may also opt out 
          of certain communications from us. To exercise these rights, please contact us using the information 
          provided below.
        </p>
